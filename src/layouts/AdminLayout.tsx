          ...
          <header className="h-16 border-b border-border bg-card shadow-soft">
            <div className="h-full px-6 flex items-center justify-between">
              <div className="flex items-center gap-4">
                <SidebarTrigger className="p-2 hover:bg-muted rounded-lg transition-colors text-foreground" />
                <div className="relative">
                  <Search className="absolute left-3 top-1/2 -translate-y-1/2 text-muted-foreground w-4 h-4" />
                  <Input
                    placeholder="Buscar produtos, vendas..."
                    className="pl-10 w-80 bg-background border-soft focus:border-primary h-10"
                  />
                </div>
              </div>
